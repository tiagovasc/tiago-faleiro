  ...
  return (
    ...
    >
      <div className="max-w-xl lg:max-w-4xl mx-10 ">
        <About.P className=" !text-3xl inline mx-0">
      ...
      <a href={signUpLink}>
        <button className="text-3xl text-gray-100 bg-blue-400 px-9 py-3 rounded-full font-bold shadow w-fit hover:opacity-75">
          Sign Up
        </button>
      </a>
    </section>
