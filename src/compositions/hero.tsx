    ...
    <section id="hero" className="relative min-h-screen">
      ...
      <div className="z-[3] absolute flex items-center justify-center w-full h-full">
        <div className="flex flex-col gap-10 w-full max-w-6xl m-10">
          ...
          <p className="max-w-[225px] sm:max-w-sm md:max-w-lg text-gray-500 dark:text-gray-300">
            "Hi! My name is Tiago. I work for Renaissance Periodization (RP) and
            I have my own coaching business where I help people with their
